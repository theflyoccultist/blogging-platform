...
router.get('/blog', authMiddleware_1.verifyToken, BlogPostController_1.getAllBlogPosts);
router.get('/blog/:id', authMiddleware_1.verifyToken, BlogPostController_1.getBlogPost);
